...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/action=voucher&code=3173dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sirex_210',
      component: () => import('@/pages/Sirex_210.vue'),
    },
    
    {
      path: '/action=voucher&code=3174dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sirex_211',
      component: () => import('@/pages/Sirex_211.vue'),
    },
    
    {
      path: '/action=voucher&code=3175dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_818',
      component: () => import('@/pages/Sandy_818.vue'),
    },
    
    {
      path: '/action=voucher&code=3176dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_819',
      component: () => import('@/pages/Sandy_819.vue'),
    },
    
    {
      path: '/action=voucher&code=3177dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_820',
      component: () => import('@/pages/Sandy_820.vue'),
    },
    
    {
      path: '/action=voucher&code=3178dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_821',
      component: () => import('@/pages/Sandy_821.vue'),
    },
    
    {
      path: '/action=voucher&code=3179dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_822',
      component: () => import('@/pages/Sandy_822.vue'),
    },
    
    {
      path: '/action=voucher&code=3180dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Enter_8',
      component: () => import('@/pages/Aksela_4.vue'),
    },
    ...
    {
      path: '/action=voucher&code=3182dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Nikita_1',
      component: () => import('@/pages/Treyzi_1.vue'),
    },
    ...
    {
      path: '/action=voucher&code=3185dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_824',
      component: () => import('@/pages/Sandy_824.vue'),
    },
    
    {
      path: '/action=voucher&code=3186dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_825',
      component: () => import('@/pages/Sandy_825.vue'),
    },
    
    {
      path: '/action=voucher&code=3187dcf5-b25b-467e-a4d3-cf597a5f6a23',
      name: 'Sandy_826',
      component: () => import('@/pages/Sandy_826.vue'),
    },
  ]
})
