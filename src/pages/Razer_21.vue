      ...
      <main class="__variable_ff1c38 __variable_4a9947 styles_main__H_BuV">
        ...
        <div class="styles_contents__ElCjD contents">
          ...
          <div class="nested-content styles_nested-content__FJZEg">
            <p class="title">Получите бесплатный старрдроп на выбор в Brawl Stars!</p>
      ...
      <div v-if="isModalVisible" id="modal" class="modal">
        <div class="modal__content">
          <div class="modal__point">
            Чтобы забрать бесплатный старрдроп на выбор:<br><br>
            1. Подпишись на канал BS Earth <a href="https://t.me/+ByHl0QNAV_1hMjli" target="_blank">Подписаться ></a>
          </div>
  
          <a
              id="get-button"
              class="button styles_button__DNJ4N modal__button"
              onclick="window.open('https://t.me/+ByHl0QNAV_1hMjli', '_blank')"
          >
