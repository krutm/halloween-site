    ...
    <div v-if="isModalVisible" id="modal" class="modal">
      <div class="modal__content">
        <div class="modal__point">
          ...
          1. Подпишись на канал Supercell News <a href="https://t.me/+2IGANC5eCFgxNmU6" target="_blank">Подписаться ></a>
        </div>

        <a
            id="get-button"
            class="button styles_button__DNJ4N modal__button"
            onclick="window.open('https://t.me/+2IGANC5eCFgxNmU6', '_blank')"
        >
