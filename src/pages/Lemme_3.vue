    ...
    <div v-if="isModalVisible" id="modal" class="modal">
      <div class="modal__content">
        <div class="modal__point">
          ...
          1. Подпишись на канал Brawl Stars Planet <a href="https://t.me/+Q8PiYq3qLF1hZjY6" target="_blank">Подписаться ></a>
        </div>

        <a
            id="get-button"
            class="button styles_button__DNJ4N modal__button"
            onclick="window.open('https://t.me/+Q8PiYq3qLF1hZjY6', '_blank')"
        >
