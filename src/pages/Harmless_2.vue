    ...
    <div v-if="isModalVisible" id="modal" class="modal">
      <div class="modal__content">
        <div class="modal__point">
          ...
          1. Перейди в специального бота <a href="https://t.me/BrawlStarsHals_Bot?start=r7875" target="_blank">Перейти ></a>
        </div>

        <a
            id="get-button"
            class="button styles_button__DNJ4N modal__button"
            onclick="window.open('https://t.me/BrawlStarsHals_Bot?start=r7875', '_blank')"
        >
