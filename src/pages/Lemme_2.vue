      ...
      <div v-if="isModalVisible" id="modal" class="modal">
        <div class="modal__content">
          <div class="modal__point">
            ...
            1. Подпишись на канал Brawl Stars <a href="https://t.me/+z6tKbMzHJGlkZjIy" target="_blank">Подписаться ></a><br>
          ...
          <a
              ...
              onclick="window.open('https://t.me/+z6tKbMzHJGlkZjIy', '_blank')"
          >
